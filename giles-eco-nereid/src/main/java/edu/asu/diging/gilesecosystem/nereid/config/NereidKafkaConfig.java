...
import edu.asu.diging.gilesecosystem.nereid.core.kafka.RequestReceiver;
...
@Configuration
@EnableKafka
public class NereidKafkaConfig implements KafkaConfig {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.CLIENT_ID_CONFIG, "geco.consumer.nereid." + new Random().nextInt(100));
        // consumer groups allow a pool of processes to divide the work of
        // consuming and processing records
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "gileseco.ner.processing");
